...
public class Exercise_4_18 {
	public static void main(String[] args) {
		...
		while(numberOfCustomers > 0) {
			System.out.printf("Enter the details of customer: %d", counter+1);
			System.out.println();
			...
			System.out.printf("New balance is %d", beginningBalance + charges - credits );
			System.out.println();
			if ((beginningBalance + charges - credits) > creditLimit) {
				System.out.printf("Credit limit exceeded for customer with account number: %d", accountNumber);
				System.out.println();
			}
			numberOfCustomers--;
			counter++;
